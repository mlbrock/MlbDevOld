...
/*
	...
	File Description	:	Finds the next record in a cache for a specified
								index method.
...
/* BOH
	...
	NAME			:	DCR_BasicGetNext

	SYNOPSIS		:	return_code = DCR_BasicGetNext(cache_ptr,
	...
	DESCRIPTION	:	Gets the next record in a cache using the specified index
						method.
	...
	PARAMETERS	:	Parameters to this function are as follow:
						...
						into which will be placed the number of the next index
						element.
						...
						into which will be placed the number of the next record
						element.
   ...
   RETURNS     :  Returns from this function are as follow:
	...
	CAVEATS		:	This function assumes that the parameters passed to it are
						...
						function (``DCR_GetNext``).

	SEE ALSO		:	DCR_GetNext
						DCR_BasicGetPrevious
	...
	OUTPUT INDEX:	DCR_BasicGetNext
						DCR Cache Get Functions:DCR_BasicGetNext
						DCR Cache Functions:DCR_BasicGetNext

	PUBLISH XREF:	DCR_BasicGetNext

	PUBLISH NAME:	DCR_BasicGetNext

EOH */
/* *********************************************************************** */
int DCR_BasicGetNext(cache_ptr, index_method, record_search_flag,
...
char         *error_text;
{
	...
	*found_flag = DCR_RECORD_NOT_FOUND;
	...
	if (entry_count && (locate_ptr->index_element < entry_count)) {
...
/* BOH
	...
	SYNOPSIS		:	return_code = DCR_GetNext(cache_ptr, index_method,
   ...
   RETURNS     :  Returns from this function are as follow:
	...
	OUTPUT INDEX:	DCR_GetNext
						DCR Cache Get Functions:DCR_GetNext
						DCR Cache Functions:DCR_GetNext

	PUBLISH XREF:	DCR_GetNext

	PUBLISH NAME:	DCR_GetNext

EOH */
/* *********************************************************************** */
int DCR_GetNext(cache_ptr, index_method, record_search_flag, found_flag,
	...
	*found_flag = DCR_RECORD_NOT_FOUND;
	...
	if ((return_code = DCR_ValidateRecSearchFlag(record_search_flag,
		...
		if ((return_code = DCR_MapDataAndIndex(cache_ptr, NULL, NULL,
			...
			return_code = DCR_BasicGetNext(cache_ptr, index_method,
