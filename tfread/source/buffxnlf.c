...
/*	***********************************************************************	*/
#ifndef NARGS
int TFREAD_ReadBufferXLateNLFILE(const char *file_name, const char *nl_string,
	unsigned int *buffer_length, char **buffer_ptr, char *error_text)
#else
int TFREAD_ReadBufferXLateNLFILE(file_name, nl_string, buffer_length,
...
#endif /* #ifndef NARGS */
{
	...
	return(TFREAD_ReadBufferXLateNLBasic(TFREAD_GetDefDataFILE(&cfile_funcs),
