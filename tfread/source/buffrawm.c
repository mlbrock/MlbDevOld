...
/*
	...
	File Description	:	Reads raw buffers using the 'MFILE' facility.
...
/*	***********************************************************************	*/
#ifndef NARGS
int TFREAD_ReadBufferRawMFILE(const char *file_name,
	unsigned int *buffer_length, char **buffer_ptr, char *error_text)
#else
int TFREAD_ReadBufferRawMFILE(file_name, buffer_length, buffer_ptr,
	error_text)
...
#endif /* #ifndef NARGS */
{
	...
	return(TFREAD_ReadBufferRawBasic(TFREAD_GetDefDataMFILE(&cfile_funcs),
