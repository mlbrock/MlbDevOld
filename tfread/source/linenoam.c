...
/*	***********************************************************************	*/
#ifndef NARGS
int TFREAD_ReadLinesNoAllocMFILE(const char *file_name,
	unsigned int *line_count, char ***line_list, char *error_text)
#else
int TFREAD_ReadLinesNoAllocMFILE(file_name, line_count, line_list,
	error_text)
...
#endif /* #ifndef NARGS */
{
	...
	return(TFREAD_ReadLinesNoAllocBasic(TFREAD_GetDefDataMFILE(&cfile_funcs),
