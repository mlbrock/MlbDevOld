...
/* BOH
	...
	NAME        :  SDTIF_Format_tm

	SYNOPSIS    :  string_ptr = SDTIF_Format_tm(in_time, buffer);
	...
	CAVEATS     :  The area to which the ``buffer`` parameter points
						should be at least ''SDTIF_FMT_TIME_LEN_TM + 1''
						(19 + 1) bytes in size.
	...
	OUTPUT INDEX:	SDTIF_Format_tm
						Date/Time Functions:SDTIF_Format_tm
						SDTIF:Functions:SDTIF_Format_tm
						SDTIF:Date/Time Functions:SDTIF_Format_tm
						System Date/Time Interface Facility Functions:See SDTIF

	PUBLISH XREF:	SDTIF_Format_tm

	PUBLISH NAME:	SDTIF_Format_tm
...
/*	***********************************************************************	*/
#ifndef NARGS
char *SDTIF_Format_tm(const struct tm *in_time, char *buffer)
#else
char *SDTIF_Format_tm(in_time, buffer)
const struct tm *in_time;
char            *buffer;
#endif /* #ifndef NARGS */
{
...
/* BOH
	...
	NAME        :  SDTIF_Format_tm_GMT

	SYNOPSIS    :  string_ptr = SDTIF_Format_tm_GMT(in_time, buffer);
	...
	OUTPUT INDEX:	SDTIF_Format_tm_GMT
						Date/Time Functions:SDTIF_Format_tm_GMT
						SDTIF:Functions:SDTIF_Format_tm_GMT
						SDTIF:Date/Time Functions:SDTIF_Format_tm_GMT
						System Date/Time Interface Facility Functions:See SDTIF

	PUBLISH XREF:	SDTIF_Format_tm_GMT

	PUBLISH NAME:	SDTIF_Format_tm_GMT
...
/*	***********************************************************************	*/
#ifndef NARGS
char *SDTIF_Format_tm_GMT(const struct tm *in_time, char *buffer)
#else
char *SDTIF_Format_tm_GMT(in_time, buffer)
const struct tm *in_time;
char            *buffer;
#endif /* #ifndef NARGS */
{
