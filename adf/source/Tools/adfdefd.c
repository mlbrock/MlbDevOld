...
/*
	...
	File Description	:	Emits the ADF definition specification equivalent to
								a combination of one or more ADF definitions files
...
#endif /* #ifndef NARGS */
{
	...
	ADF_EMIT_Def(domain_count, domain_list, NULL, NULL);
