...
/*
	...
	File Description	:	Manages the retrieval of rows from a Sybase database
								for the Sybase DB-LIB facility.
...
/*	BOH
   ...
   NAME        :	DBC_DBLIB_GetRows

   SYNOPSIS    :	return_code = DBC_DBLIB_GetRows(dbc_control_ptr,
   ...
   OUTPUT INDEX:	DBC_DBLIB_GetRows
						DBC Sybase DB-LIB Functions:DBC_DBLIB_GetRows
						DBC Functions:Row Retrieval Functions:DBC_DBLIB_GetRows

   PUBLISH XREF:	DBC_DBLIB_GetRows

   PUBLISH NAME:	DBC_DBLIB_GetRows
...
/*	***********************************************************************	*/
#ifndef NARGS
int DBC_DBLIB_GetRows(DBC_DBLIB *dbc_control_ptr, unsigned int member_count,
...
#else
int DBC_DBLIB_GetRows(dbc_control_ptr, member_count, member_list, sql_command,
...
#endif /* #ifndef NARGS */
{
	...
	*out_row_list              = NULL;
	...
	return(DBC_DBLIB_GetRowsBasic(dbc_control_ptr, &get_rows, out_row_count,
...
/*	***********************************************************************	*/
#ifndef NARGS
int DBC_DBLIB_GetRowsBasic(DBC_DBLIB *dbc_control_ptr,
	const DBC_GETROWS *get_rows_ptr, unsigned int *out_row_count,
	void **out_row_list, char *error_text)
#else
int DBC_DBLIB_GetRowsBasic(dbc_control_ptr, get_rows_ptr, out_row_count,
	out_row_list, error_text)
DBC_DBLIB          *dbc_control_ptr;
...
#endif /* #ifndef NARGS */
{
	...
	*out_row_list                  = NULL;
	...
	if ((return_code = DBC_DBLIB_DoSQLCommand(dbc_control_ptr,
	...
	if ((return_code = DBC_DBLIB_BindMembers(dbc_control_ptr,
