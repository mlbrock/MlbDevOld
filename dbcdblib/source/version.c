...
/*
	...
	File Description	:	Returns the DBC Sybase DB-LIB library version number.
...
/*	BOH
   ...
   NAME        :	DBC_DBLIB_GetVersion

   SYNOPSIS    :	return_ptr = DBC_DBLIB_GetVersion(version_number);
   ...
   DESCRIPTION :	Initializes a ''STR_VERSION'' structure with the DBC Sybase
						DB-LIB library version number.

   PARAMETERS  :	Parameters to this function are as follow:

						(.) ``version_number`` is a pointer to a ''STR_VERSION''
						into which this function is to place the DBC Sybase DB-LIB
   ...
   NOTES       :	This function returns the version number of the DBC Sybase
						DB-LIB facility, which is ''NOT'' the same version number
						as that returned by the function ``DBC_GetVersion``.

   CAVEATS     :	

   SEE ALSO    :	DBC_DBLIB_GetVersionString
   ...
   OUTPUT INDEX:	DBC_DBLIB_GetVersion
						...
						DBC Functions:DBC_DBLIB_GetVersion

   PUBLISH XREF:	DBC_DBLIB_GetVersion

   PUBLISH NAME:	DBC_DBLIB_GetVersion
...
/*	***********************************************************************	*/
#ifndef NARGS
STR_VERSION *DBC_DBLIB_GetVersion(STR_VERSION *version_number)
#else
STR_VERSION *DBC_DBLIB_GetVersion(version_number)
STR_VERSION *version_number;
#endif /* #ifndef NARGS */
{
	STR_VERSION_NUMBER_SET(DBC_DBLIB_VERSION_MAJOR, DBC_DBLIB_VERSION_MINOR,
		DBC_DBLIB_VERSION_RELEASE, DBC_DBLIB_VERSION_BUILD, version_number);
...
/*	BOH
   ...
   NAME        :	DBC_DBLIB_GetVersionString

   SYNOPSIS    :	return_ptr = DBC_DBLIB_GetVersionString(version_string);
   ...
   PARAMETERS  :	Parameters to this function are as follow:
						...
						equivalent of the DBC Sybase DB-LIB library version number.
   ...
   NOTES       :	This function returns the version string of the DBC Sybase
						DB-LIB facility, which is ''NOT'' the same version string
						as that returned by the function ``DBC_GetVersionString``.

   CAVEATS     :	

   SEE ALSO    :	DBC_DBLIB_GetVersion
   ...
   OUTPUT INDEX:	DBC_DBLIB_GetVersionString
						...
						DBC Functions:DBC_DBLIB_GetVersionString

   PUBLISH XREF:	DBC_DBLIB_GetVersionString

   PUBLISH NAME:	DBC_DBLIB_GetVersionString
...
/*	***********************************************************************	*/
#ifndef NARGS
char *DBC_DBLIB_GetVersionString(char *version_string)
#else
char *DBC_DBLIB_GetVersionString(version_string)
char *version_string;
#endif /* #ifndef NARGS */
{
	STR_VERSION version_number;
	
	return(vertostr(DBC_DBLIB_GetVersion(&version_number), version_string));
}
/* *********************************************************************** */
...
int main()
{
	...
	fprintf(stderr, "%s\n%s\n",
		"Test routine for functions 'DBC_DBLIB_GetVersion()'",
		"                           'DBC_DBLIB_GetVersionString()'");
	fprintf(stderr,
		"---- ------- --- --------- ------------------------------\n\n");

	STR_EMIT_CharLine('=', 78, NULL, NULL);
	printf("DBC Sybase DB-LIB System Version Number: %s\n",
		DBC_DBLIB_GetVersionString(version_string));
	STR_EMIT_CharLine('-', 78, NULL, NULL);
	printf("Version Number 1: %03u %03u %03u %03u\n",
		((unsigned int) DBC_DBLIB_VERSION_MAJOR),
		((unsigned int) DBC_DBLIB_VERSION_MINOR),
		((unsigned int) DBC_DBLIB_VERSION_RELEASE),
		((unsigned int) DBC_DBLIB_VERSION_BUILD));
	DBC_DBLIB_GetVersion(&version_number);
