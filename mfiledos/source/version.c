...
/*	BOH
   ...
   AUTHOR      :	Michael L. Brock
	...
	COPYRIGHT	:	Copyright 1996 - 2002 Michael L. Brock
...
EOH */
/*	***********************************************************************	*/
STR_VERSION *MFILE_GetVersion(version_number)
STR_VERSION *version_number;
{
	STR_VERSION_NUMBER_SET(MFILE_VERSION_MAJOR, MFILE_VERSION_MINOR,
...
/*	BOH
   ...
   DESCRIPTION :	Constructs a human-readable string equivalent of the
						...
						A formatted MFILE version number string has the
						generalized format:
...
int main()
{
	...
	printf("MFILE System Version Number:\n");
	STR_EMIT_CharLine('-', 78, NULL, NULL);
