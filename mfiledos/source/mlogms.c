...
/* BOH
   ...
   PARAMETERS  :  Parameters to this function are as follow:
						...
						will not be posted to a memory-mapped file. 
   ...
   EXAMPLES    :  
	...
	OUTPUT INDEX:	MFILE_LogMessage
						Memory-mapped File Functions:MFILE_LogMessage
...
#endif /* #ifndef NO_STDARGS */
{
	...
	mfile_ptr = (mfile_ptr->file_ptr == file_ptr) ? NULL : mfile_ptr;
...
/* BOH
   ...
   AUTHOR      :  Michael L. Brock
	...
	OUTPUT INDEX:	MFILE_GetLogMessageFlagFILE
						Memory-mapped File Functions:MFILE_GetLogMessageFlagFILE
...
/* BOH
   ...
   AUTHOR      :  Michael L. Brock
	...
	OUTPUT INDEX:	MFILE_GetLogMessageFlagGMT
						Memory-mapped File Functions:MFILE_GetLogMessageFlagGMT
...
int main()
{
	...
	if (!(m_file_ptr = mopen(TEST_FILE, "w"))) {
