...
/*
	...
	File Description	:	Dumps a single Sybase field in text format.
...
/*	BOH
   ...
   NAME        :	DBC_SYB_DumpField

   SYNOPSIS    :	void DBC_SYB_DumpField(type_count, type_list,
   ...
   DESCRIPTION :	Dumps a single Sybase field in text format.
   ...
   OUTPUT INDEX:	DBC_SYB_DumpField
						Dump Functions:DBC_SYB_DumpField
						DBC Sybase Functions:DBC_SYB_DumpField
						DBC Functions:Dump Functions:DBC_SYB_DumpField

   PUBLISH XREF:	DBC_SYB_DumpField

   PUBLISH NAME:	DBC_SYB_DumpField
...
/*	***********************************************************************	*/
#ifndef NARGS
void DBC_SYB_DumpField(unsigned int type_count, const DTA_TYPE *type_list,
...
#else
void DBC_SYB_DumpField(type_count, type_list, member_ptr, record_ptr,
...
#endif /* #ifndef NARGS */
{
   ...
   DTIME         tmp_dtime;
	...
	if ((member_ptr->dump_function != NULL) &&
		(member_ptr->dump_function != DBC_SYB_DumpField)) {
