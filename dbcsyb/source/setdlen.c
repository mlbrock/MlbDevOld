...
/*	BOH
   ...
   NAME        :	DBC_SYB_SetDisplayLength

   SYNOPSIS    :	return_code = DBC_SYB_SetDisplayLength(type_count,
   ...
   OUTPUT INDEX:	DBC_SYB_SetDisplayLength
						Member Description Functions:DBC_SYB_SetDisplayLength
						DBC Sybase Functions:DBC_SYB_SetDisplayLength
						DBC Functions:Member Description Functions:DBC_SYB_SetDisplayLength

   PUBLISH XREF:	DBC_SYB_SetDisplayLength

   PUBLISH NAME:	DBC_SYB_SetDisplayLength
...
/*	***********************************************************************	*/
#ifndef NARGS
int DBC_SYB_SetDisplayLength(unsigned int type_count,
...
#else
int DBC_SYB_SetDisplayLength(type_count, type_list, member_ptr,
...
#endif /* #ifndef NARGS */
{
	...
	if ((member_ptr->length_function != NULL) &&
		(member_ptr->length_function != DBC_SYB_SetDisplayLength))
	...
	/*	*****************************************************************	*/
	/*	*****************************************************************	*/
	/*		Otherwise, we determine the length based upon the Sybase	types	*/
