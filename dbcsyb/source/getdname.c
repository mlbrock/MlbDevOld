...
/* *********************************************************************** */
#ifndef NARGS
int DBC_SYB_GetDBName(const char *spec_string, unsigned int *name_count,
	DBC_SYB_NAME **name_list, char *error_text)
#else
int DBC_SYB_GetDBName(spec_string, name_count, name_list, error_text)
...
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = DBC_Open(&dbc_context_data, NULL, "DBC:GetDBNames",
		...
		return_code = DBC_SYB_GetDBNameBasic(dbc_context_data.dbc_control_ptr,
...
/* *********************************************************************** */
#ifndef NARGS
int DBC_SYB_GetDBNameBasic(void *dbc_control_ptr, unsigned int *name_count,
	DBC_SYB_NAME **name_list, char *error_text)
#else
int DBC_SYB_GetDBNameBasic(dbc_control_ptr, name_count, name_list, error_text)
...
#endif /* #ifndef NARGS */
{
	return(DBC_SYB_GetNameListBasic(dbc_control_ptr,
...
/* *********************************************************************** */
#ifndef NARGS
int DBC_SYB_GetUserDBName(const char *spec_string, unsigned int *name_count,
	DBC_SYB_NAME **name_list, char *error_text)
#else
int DBC_SYB_GetUserDBName(spec_string, name_count, name_list, error_text)
const char    *spec_string;
unsigned int  *name_count;
DBC_SYB_NAME **name_list;
char          *error_text;
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = DBC_Open(&dbc_context_data, NULL, "DBC:GetUserDBNames",
		spec_string, NULL, DBC_FLAG_NONE, NULL, error_text)) == DBC_SUCCESS) {
		return_code =
			DBC_SYB_GetUserDBNameBasic(dbc_context_data.dbc_control_ptr,
			name_count, name_list, error_text);
		DBC_Close(&dbc_context_data);
	}
	else {
...
/* *********************************************************************** */
#ifndef NARGS
int DBC_SYB_GetUserDBNameBasic(void *dbc_control_ptr, unsigned int *name_count,
	DBC_SYB_NAME **name_list, char *error_text)
#else
int DBC_SYB_GetUserDBNameBasic(dbc_control_ptr, name_count, name_list,
	error_text)
void          *dbc_control_ptr;
unsigned int  *name_count;
DBC_SYB_NAME **name_list;
...
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = DBC_SYB_GetDBNameBasic(dbc_control_ptr, name_count,
		name_list, error_text)) == DBC_SUCCESS) {
		for (count_1 = 0; count_1 < *name_count; ) {
			if (DBC_SYB_IsSystemDatabase((*name_list)[count_1].name))
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test routine for 'DBC_SYB_GetDBName()'\n");
	fprintf(stderr, "---- ------- --- ---------------------\n");
	...
	if ((return_code = DBC_SYB_GetDBName(argv[1], &name_count, &name_list,
	...
	if ((return_code = DBC_SYB_GetUserDBName(argv[1], &name_count, &name_list,
		error_text)) != DBC_SUCCESS)
		goto EXIT_FUNCTION;
