...
/*
	...
	File Description	:	Miscellaneous Sybase date type functions.
...
/*	***********************************************************************	*/
#ifndef NARGS
int DBC_SYB_IsDate(int dbc_type)
#else
int DBC_SYB_IsDate(dbc_type)
int dbc_type;
#endif /* #ifndef NARGS */
{
...
/*	***********************************************************************	*/
#ifndef NARGS
int DBC_SYB_MinDate(int dbc_type, DTIME *dtime_ptr, char *error_text)
#else
int DBC_SYB_MinDate(dbc_type, dtime_ptr, error_text)
int    dbc_type;
DTIME *dtime_ptr;
char  *error_text;
#endif /* #ifndef NARGS */
...
/*	***********************************************************************	*/
#ifndef NARGS
int DBC_SYB_MaxDate(int dbc_type, DTIME *dtime_ptr, char *error_text)
#else
int DBC_SYB_MaxDate(dbc_type, dtime_ptr, error_text)
int    dbc_type;
DTIME *dtime_ptr;
char  *error_text;
#endif /* #ifndef NARGS */
