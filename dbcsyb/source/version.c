...
/*
	...
	File Description	:	Returns the DBC Sybase library version number.
...
/*	BOH
   ...
   NAME        :	DBC_SYB_GetVersion

   SYNOPSIS    :	return_ptr = DBC_SYB_GetVersion(version_number);
   ...
   PARAMETERS  :	Parameters to this function are as follow:
						...
						into which this function is to place the DBC Sybase library
						version number.
   ...
   SEE ALSO    :	DBC_SYB_GetVersionString
   ...
   OUTPUT INDEX:	DBC_SYB_GetVersion
						DBC Sybase Functions:DBC_SYB_GetVersion
						DBC Functions:DBC_SYB_GetVersion

   PUBLISH XREF:	DBC_SYB_GetVersion

   PUBLISH NAME:	DBC_SYB_GetVersion
...
/*	***********************************************************************	*/
#ifndef NARGS
STR_VERSION *DBC_SYB_GetVersion(STR_VERSION *version_number)
#else
STR_VERSION *DBC_SYB_GetVersion(version_number)
STR_VERSION *version_number;
#endif /* #ifndef NARGS */
{
	STR_VERSION_NUMBER_SET(DBC_SYB_VERSION_MAJOR, DBC_SYB_VERSION_MINOR,
		DBC_SYB_VERSION_RELEASE, DBC_SYB_VERSION_BUILD, version_number);
...
/*	BOH
   ...
   NAME        :	DBC_SYB_GetVersionString

   SYNOPSIS    :	return_ptr = DBC_SYB_GetVersionString(version_string);
   ...
   PARAMETERS  :	Parameters to this function are as follow:
						...
						equivalent of the DBC Sybase library version number.
   ...
   OUTPUT INDEX:	DBC_SYB_GetVersionString
						DBC Sybase Functions:DBC_SYB_GetVersionString
						DBC Functions:DBC_SYB_GetVersionString

   PUBLISH XREF:	DBC_SYB_GetVersionString

   PUBLISH NAME:	DBC_SYB_GetVersionString
...
/*	***********************************************************************	*/
#ifndef NARGS
char *DBC_SYB_GetVersionString(char *version_string)
#else
char *DBC_SYB_GetVersionString(version_string)
char *version_string;
#endif /* #ifndef NARGS */
{
	STR_VERSION version_number;
	
	return(vertostr(DBC_SYB_GetVersion(&version_number), version_string));
}
/* *********************************************************************** */
...
int main()
{
	...
	fprintf(stderr, "%s\n%s\n",
		"Test routine for functions 'DBC_SYB_GetVersion()'",
		"                           'DBC_SYB_GetVersionString()'");
	fprintf(stderr,
		"---- ------- --- --------- ----------------------------\n\n");

	STR_EMIT_CharLine('=', 78, NULL, NULL);
	printf("DBC Sybase System Version Number: %s\n",
		DBC_SYB_GetVersionString(version_string));
	STR_EMIT_CharLine('-', 78, NULL, NULL);
	printf("Version Number 1: %03u %03u %03u %03u\n",
		((unsigned int) DBC_SYB_VERSION_MAJOR),
		((unsigned int) DBC_SYB_VERSION_MINOR),
		((unsigned int) DBC_SYB_VERSION_RELEASE),
		((unsigned int) DBC_SYB_VERSION_BUILD));
	DBC_SYB_GetVersion(&version_number);
