...
/*
	...
	File Description	:	Formats an 'rvcm_Error' code with the value, its
...
/*	***********************************************************************	*/
char *RVUTIL_FormatString_rvcm_Error(rv_Session in_session,
	rvcm_Error in_code, char *out_text)
{
	...
	return(chrcat(strcat(strcat(strcat(strcat(
		...
		" = '"),
		RVUTIL_CodeToString_rvcm_Error(in_code, buffer)),
		"' = '"),
		rvcm_ErrorText(in_session, in_code)),
		'\''));
}
/*	***********************************************************************	*/
