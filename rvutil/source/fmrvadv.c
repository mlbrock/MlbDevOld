...
/*
	...
	File Description	:	Formats an 'rvadv_Error' code with the value, its
...
/*	***********************************************************************	*/
char *RVUTIL_FormatString_rvadv_Error(rv_Session in_session,
	rvadv_Error in_code, char *out_text)
{
	...
	return(chrcat(strcat(strcat(strcat(strcat(
		...
		" = '"),
		RVUTIL_CodeToString_rvadv_Error(in_code, buffer)),
		"' = '"),
		rvadv_ErrorText(in_session, in_code)),
		'\''));
}
/*	***********************************************************************	*/
