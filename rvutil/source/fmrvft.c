...
/*
	...
	File Description	:	Formats an 'rvft_Error' code with the value, its
...
/*	***********************************************************************	*/
char *RVUTIL_FormatString_rvft_Error(rv_Session in_session,
	rvft_Error in_code, char *out_text)
{
	...
	return(chrcat(strcat(strcat(strcat(strcat(
		...
		" = '"),
		RVUTIL_CodeToString_rvft_Error(in_code, buffer)),
		"' = '"),
		rvft_ErrorText(in_session, in_code)),
		'\''));
}
/*	***********************************************************************	*/
