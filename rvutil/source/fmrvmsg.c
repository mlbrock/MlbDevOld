...
/*
	...
	File Description	:	Formats an 'rvmsg_Error' code with the value, its
...
/*	***********************************************************************	*/
char *RVUTIL_FormatString_rvmsg_Error(rv_Session in_session,
	rvmsg_Error in_code, char *out_text)
{
	...
	return(chrcat(strcat(strcat(strcat(strcat(
		...
		" = '"),
		RVUTIL_CodeToString_rvmsg_Error(in_code, buffer)),
		"' = '"),
		rvmsg_ErrorText(in_session, in_code)),
		'\''));
}
/*	***********************************************************************	*/
