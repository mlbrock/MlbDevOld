...
/*
	...
	File Description	:	Formats an 'rv_Error' code with the value, its
...
/*	***********************************************************************	*/
char *RVUTIL_FormatString_rv_Error(rv_Session in_session,
	rv_Error in_code, char *out_text)
{
	...
	return(chrcat(strcat(strcat(strcat(strcat(
		...
		" = '"),
		RVUTIL_CodeToString_rv_Error(in_code, buffer)),
		"' = '"),
		rv_ErrorText(in_session, in_code)),
		'\''));
}
/*	***********************************************************************	*/
