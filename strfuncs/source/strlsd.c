...
/*
	...
	File Description	:	Array of pointers to strings search delta logic.
...
/* BOH
   ...
   NAME        :  strl_search_delta

   SYNOPSIS    :  return_code = strl_search_delta(in_count_1, in_list_1,
							in_count_2, in_list_2, uniq_count_1, uniq_list_1,
							uniq_count_2, uniq_list_2, same_count_1, same_list_1,
							same_count_2, same_list_2);
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						...
						using ``STR_strcmp`` as a comparison functions.
   ...
   OUTPUT INDEX:  strl_search_delta
						String List Search Delta Functions:strl_search_delta
						STRFUNCS:String List Search Delta Functions:strl_search_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  strl_search_delta

   PUBLISH NAME:	strl_search_delta
...
/* *********************************************************************** */
#ifndef NARGS
int strl_search_delta(unsigned int in_count_1, char **in_list_1,
...
#else
int strl_search_delta(in_count_1, in_list_1, in_count_2, in_list_2,
	uniq_count_1, uniq_list_1, uniq_count_2, uniq_list_2, same_count_1,
	same_list_1, same_count_2, same_list_2)
unsigned int   in_count_1;
char         **in_list_1;
unsigned int   in_count_2;
char         **in_list_2;
...
#endif /* #ifndef NARGS */
{
	...
	return(MEM_LIST_search_delta(NULL, in_count_1, ((void **) in_list_1),
		...
		&diff_list_2, same_count_1, same_list_1, same_count_2, same_list_2, 0,
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'strl_search_delta()'\n");
	fprintf(stderr, "---- -- -------- ---------------------\n\n");
	...
	else if ((return_code = strl_search_delta(file_count_1, file_list_1,
		file_count_2, file_list_2, &uniq_count_1, &uniq_list_1, &uniq_count_2,
		&uniq_list_2, &same_count_1, &same_list_1, &same_count_2,
		&same_list_2)) != STRFUNCS_SUCCESS) {
...
#endif /* #ifndef NARGS */
{
	...
	*file_list  = NULL;
	...
	if ((file_ptr = fopen(file_name, "r")) == NULL) {
		...
		fclose(file_ptr);
		if (!return_code)
			strl_sort(*file_count, *file_list);
	}
