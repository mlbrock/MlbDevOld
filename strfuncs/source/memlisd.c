...
/*
	...
	File Description	:	Case-insensitive array of pointers search delta logic.
...
/* BOH
   ...
   NAME        :  memli_search_delta

   SYNOPSIS    :  return_code = memli_search_delta(in_count_1, in_list_1,
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						...
						``MEM_memicmp`` as a comparison functions.
   ...
   OUTPUT INDEX:  memli_search_delta
						Memory List Search Delta Functions:memli_search_delta
						STRFUNCS:Memory List Search Delta Functions:memli_search_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  memli_search_delta

   PUBLISH NAME:	memli_search_delta
...
/* *********************************************************************** */
#ifndef NARGS
int memli_search_delta(unsigned int in_count_1, void **in_list_1,
...
#else
int memli_search_delta(in_count_1, in_list_1, in_count_2, in_list_2,
...
#endif /* #ifndef NARGS */
{
	...
	return(MEM_LIST_search_delta(NULL, in_count_1, in_list_1, in_count_2,
		...
		same_list_1, same_count_2, same_list_2, data_length, MEM_memicmp,
		MEM_memicmp));
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'memli_search_delta()'\n");
	fprintf(stderr, "---- -- -------- ----------------------\n\n");
	...
	else if ((return_code = memli_search_delta(file_count_1, file_list_1,
