...
/* BOH
   ...
   SYNOPSIS    :  return_code = STR_LIST_find(data_count, data_list, key_data,
							data_length, found_index, compare_function);
   ...
   DESCRIPTION :  Performs a binary search in the array of pointers
						``data_list`` for the element ``key_data`` using the
   ...
   PARAMETERS  :  Parameters to this function are as follow:
						...
						contains the number of elements in the array of pointers
						``data_list``.

						(.) ``data_list`` is a pointer to ``void`` which contains
						the array of pointers to be searched.
   ...
   OUTPUT INDEX:  STR_LIST_find
						Memory List Functions:STR_LIST_find
						STRFUNCS:Memory List Functions:STR_LIST_find
						String Functions:See STRFUNCS

   PUBLISH XREF:  STR_LIST_find

   PUBLISH NAME:	STR_LIST_find
...
/* *********************************************************************** */
#ifndef NARGS
int STR_LIST_find(unsigned int data_count, void **data_list,
	const void *key_data, size_t data_length, unsigned int *found_index,
	int (*compare_function)(void *, const void *, const void *, size_t))
#else
int STR_LIST_find(data_count, data_list, key_data, data_length, found_index,
	compare_function)
unsigned int   data_count;
void         **data_list;
const void    *key_data;
...
#endif /* #ifndef NARGS */
{
	return(STR_LIST_bsearch(NULL, data_count, data_list, key_data, data_length,
		found_index, STRFUNCS_DIRECTION_TOP, compare_function));
}
/* *********************************************************************** */
