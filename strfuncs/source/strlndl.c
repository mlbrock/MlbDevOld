...
/* BOH
   ...
   SYNOPSIS    :  return_code = strln_delete(string_count, string_list,
   ...
   OUTPUT INDEX:  strln_delete
						String List Functions:strln_delete
						STRFUNCS:String List Functions:strln_delete
						String Functions:See STRFUNCS

   PUBLISH XREF:  strln_delete

   PUBLISH NAME:	strln_delete
...
/* *********************************************************************** */
#ifndef NARGS
int strln_delete(unsigned int *string_count, char ***string_list,
	const char *key_string, size_t string_length, unsigned int *found_index)
#else
int strln_delete(string_count, string_list, key_string, string_length,
	found_index)
unsigned int   *string_count;
char         ***string_list;
const char     *key_string;
