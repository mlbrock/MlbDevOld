...
/* BOH
	...
	SYNOPSIS		:	int idxistr(search_string, target_string);
   ...
   PARAMETERS  :  Parameters to this function are as follow:
	...
	OUTPUT INDEX:	idxistr
						String Search Functions/Index:idxistr
						STRFUNCS:String Search Functions/Index:idxistr
						String Functions:See STRFUNCS

	PUBLISH XREF:	idxistr

	PUBLISH NAME:	idxistr
...
/*	***********************************************************************	*/
#ifndef NARGS
int idxistr(const char *search_string, const char *target_string)
#else
int idxistr(search_string, target_string)
const char *search_string;
const char *target_string;
#endif /* #ifndef NARGS */
{
	...
	if ((found_ptr = stristr(search_string, target_string)) != NULL)
