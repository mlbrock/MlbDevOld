...
/* BOH
   ...
   SYNOPSIS    :  return_code = STR_strncmp(control_ptr, string_ptr_1,
   ...
   DESCRIPTION :  Compares the two strings (to which the parameters
						...
						null-termination is reached (ASCII 0), or ``string_length``
   ...
   OUTPUT INDEX:  STR_strncmp
						String List Functions:STR_strncmp
						STRFUNCS:String List Functions:STR_strncmp
						String Functions:See STRFUNCS

   PUBLISH XREF:  STR_strncmp

   PUBLISH NAME:	STR_strncmp
...
/* *********************************************************************** */
#ifndef NARGS
int STR_strncmp(void *control_ptr, const char *string_ptr_1,
	const char *string_ptr_2, size_t string_length)
#else
int STR_strncmp(control_ptr, string_ptr_1, string_ptr_2, string_length)
void       *control_ptr;
const char *string_ptr_1;
const char *string_ptr_2;
size_t      string_length;
#endif /* #ifndef NARGS */
{
	return(strncmp(string_ptr_1, string_ptr_2, string_length));
}
/* *********************************************************************** */
#ifdef _MSC_VER
