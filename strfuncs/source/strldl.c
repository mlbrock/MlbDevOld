...
/* BOH
   ...
   SYNOPSIS    :  return_code = strl_delete(string_count, string_list,
   ...
   PARAMETERS  :  Parameters to this function are as follow:
						...
						which the index of ``key_string`` in ``string_list``
						will be placed, if found.
   ...
   RETURNS     :  Returns from this function are as follow:
						...
						in the array ``string_list``. In this case, the element
						is deleted from the array and the unsigned int to which
						the ``found_index`` parameter points will be set to its
						former index.
						...
						points will be set to the index of ``key_string`` did it
						reside in the array.
   ...
   PUBLISH XREF:  strl_delete

   PUBLISH NAME:	strl_delete
...
/* *********************************************************************** */
#ifndef NARGS
int strl_delete(unsigned int *string_count, char ***string_list,
	const char *key_string, unsigned int *found_index)
#else
int strl_delete(string_count, string_list, key_string, found_index)
unsigned int   *string_count;
char         ***string_list;
const char     *key_string;
unsigned int   *found_index;
