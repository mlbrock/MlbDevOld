...
/* BOH
	...
	SYNOPSIS		:	int idxstrn(search_string, target_string, target_length);
   ...
   PARAMETERS  :  Parameters to this function are as follow:
	...
	OUTPUT INDEX:	idxstrn
						String Search Functions/Index:idxstrn
						STRFUNCS:String Search Functions/Index:idxstrn
						String Functions:See STRFUNCS
 
	PUBLISH XREF:	idxstrn

	PUBLISH NAME:	idxstrn
...
/*	***********************************************************************	*/
#ifndef NARGS
int idxstrn(const char *search_string, const char *target_string,
	size_t target_length)
#else
int idxstrn(search_string, target_string, target_length)
const char *search_string;
const char *target_string;
size_t      target_length;
#endif /* #ifndef NARGS */
{
	...
	if ((found_ptr = strstrn(search_string, target_string,
		target_length)) != NULL)
