...
/*
	...
	File Description	:	Array of pointers non-search delta logic.
...
/* BOH
   ...
   SYNOPSIS    :  return_code = meml_delta(string_count_1, string_list_1,
   ...
   OUTPUT INDEX:  meml_delta
						Memory List Delta Functions:meml_delta
						STRFUNCS:Memory List Delta Functions:meml_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  meml_delta

   PUBLISH NAME:	meml_delta
...
/* *********************************************************************** */
#ifndef NARGS
int meml_delta(unsigned int string_count_1, void **string_list_1,
...
#else
int meml_delta(string_count_1, string_list_1, string_count_2, string_list_2,
...
#endif /* #ifndef NARGS */
{
	return(MEM_LIST_delta(NULL, string_count_1, ((void **) string_list_1),
		...
		same_count, same_list, data_length, MEM_memcmp));
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'meml_delta()'\n");
	fprintf(stderr, "---- -- -------- --------------\n\n");
	...
	else if ((return_code = meml_delta(file_count_1, file_list_1, file_count_2,
