...
/* BOH
   ...
   NAME        :  strln_search_delta

   SYNOPSIS    :  return_code = strln_search_delta(in_count_1, in_list_1,
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						...
						using ``STR_strncmp`` as a comparison functions.
   ...
   OUTPUT INDEX:  strln_search_delta
						String List Search Delta Functions:strln_search_delta
						STRFUNCS:String List Search Delta Functions:strln_search_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  strln_search_delta

   PUBLISH NAME:	strln_search_delta
...
/* *********************************************************************** */
#ifndef NARGS
int strln_search_delta(unsigned int in_count_1, char **in_list_1,
	...
	size_t string_length)
#else
int strln_search_delta(in_count_1, in_list_1, in_count_2, in_list_2,
...
#endif /* #ifndef NARGS */
{
	...
	return(MEM_LIST_search_delta(NULL, in_count_1, ((void **) in_list_1),
		...
		uniq_count_2, uniq_list_2, &diff_count_1, &diff_list_1, &diff_count_2,
		&diff_list_2, same_count_1, same_list_1, same_count_2, same_list_2,
		string_length, STR_strncmp, STR_strcmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'strln_search_delta()'\n");
	fprintf(stderr, "---- -- -------- ----------------------\n\n");
	...
	else if ((return_code = strln_search_delta(file_count_1, file_list_1,
...
#endif /* #ifndef NARGS */
{
	...
	*file_list  = NULL;
	...
	if ((file_ptr = fopen(file_name, "r")) == NULL) {
		...
		fclose(file_ptr);
		if (!return_code)
			strln_sort(*file_count, *file_list, COMPARE_LENGTH);
	}
