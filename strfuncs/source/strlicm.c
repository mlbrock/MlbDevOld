...
/* BOH
   ...
   SYNOPSIS    :  return_code = STR_stricmp(control_ptr, string_ptr_1,
   ...
   OUTPUT INDEX:  STR_stricmp
						String List Functions:STR_stricmp
						STRFUNCS:String List Functions:STR_stricmp
						String Functions:See STRFUNCS

   PUBLISH XREF:  STR_stricmp

   PUBLISH NAME:	STR_stricmp
...
/* *********************************************************************** */
#ifndef NARGS
int STR_stricmp(void *control_ptr, const char *string_ptr_1,
	const char *string_ptr_2, size_t string_length)
#else
int STR_stricmp(control_ptr, string_ptr_1, string_ptr_2, string_length)
void       *control_ptr;
const char *string_ptr_1;
const char *string_ptr_2;
size_t      string_length;
