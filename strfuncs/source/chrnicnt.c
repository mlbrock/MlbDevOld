...
/*	*********************************************************************** */
#ifndef NARGS
size_t chrnicnt(const char *search_string, int target_char,
	size_t search_length)
#else
size_t chrnicnt(search_string, target_char, search_length)
...
#endif /* #ifndef NARGS */
{
	...
	return(memicnt(search_length, search_string, 1, &temp_char));
}
/* *********************************************************************** */
