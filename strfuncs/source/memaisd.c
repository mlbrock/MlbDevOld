...
/*
	...
	File Description	:	Case-insensitive array search delta logic.
...
/* BOH
   ...
   NAME        :  memai_search_delta

   SYNOPSIS    :  return_code = memai_search_delta(in_count_1, in_list_1,
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						by performing binary searches using ``MEM_memicmp`` as a
   ...
   OUTPUT INDEX:  memai_search_delta
						Memory Array Search Delta Functions:memai_search_delta
						STRFUNCS:Memory Array Search Delta Functions:memai_search_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  memai_search_delta

   PUBLISH NAME:	memai_search_delta
...
/* *********************************************************************** */
#ifndef NARGS
int memai_search_delta(unsigned int in_count_1, const void *in_list_1,
...
#else
int memai_search_delta(in_count_1, in_list_1, in_count_2, in_list_2,
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'memai_search_delta()'\n");
	fprintf(stderr, "---- -- -------- ----------------------\n\n");
	...
	else if ((return_code = memai_search_delta(file_count_1, file_list_1,
