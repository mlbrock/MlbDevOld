...
/* BOH
   ...
   SYNOPSIS    :  return_code = strli_delta(string_count_1, string_list_1,
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						of pointers to strings using ``STR_stricmp``.
   ...
   OUTPUT INDEX:  strli_delta
						String List Delta Functions:strli_delta
						STRFUNCS:String List Delta Functions:strli_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  strli_delta

   PUBLISH NAME:	strli_delta
...
/* *********************************************************************** */
#ifndef NARGS
int strli_delta(unsigned int string_count_1, char **string_list_1,
...
#else
int strli_delta(string_count_1, string_list_1, string_count_2, string_list_2,
...
#endif /* #ifndef NARGS */
{
	...
	return(MEM_LIST_delta(NULL, string_count_1, ((void **) string_list_1),
		string_count_2, ((void **) string_list_2), uniq_count_1,
		uniq_list_1, uniq_count_2, uniq_list_2, diff_count, diff_list,
		same_count, same_list, 0, STR_stricmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'strli_delta()'\n");
	fprintf(stderr, "---- -- -------- ---------------\n\n");
	...
	else if ((return_code = strli_delta(file_count_1, file_list_1, file_count_2,
