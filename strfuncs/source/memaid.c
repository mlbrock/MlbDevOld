...
/*
	...
	File Description	:	Case-insensitive array non-search delta logic.
...
/* BOH
   ...
   SYNOPSIS    :  return_code = memai_delta(in_count_1, in_list_1, in_count_2,
   ...
   OUTPUT INDEX:  memai_delta
						Memory Array Delta Functions:memai_delta
						STRFUNCS:Memory Array Delta Functions:memai_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  memai_delta

   PUBLISH NAME:	memai_delta
...
/* *********************************************************************** */
#ifndef NARGS
int memai_delta(unsigned int in_count_1, const void *in_list_1,
...
#else
int memai_delta(in_count_1, in_list_1, in_count_2, in_list_2, uniq_count_1,
...
#endif /* #ifndef NARGS */
{
	return(MEM_ARRAY_delta(NULL, in_count_1, in_list_1, in_count_2, in_list_2,
		...
		diff_list, same_count, same_list, data_length, MEM_memicmp));
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'memai_delta()'\n");
	fprintf(stderr, "---- -- -------- ---------------\n\n");
	...
	else if ((return_code = memai_delta(file_count_1, file_list_1, file_count_2,
