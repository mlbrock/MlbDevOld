...
/* BOH
	...
	SYNOPSIS		:	int idxnstr(search_string, target_string, search_length);
   ...
   PARAMETERS  :  Parameters to this function are as follow:
	...
	OUTPUT INDEX:	idxnstr
						String Search Functions/Index:idxnstr
						STRFUNCS:String Search Functions/Index:idxnstr
						String Functions:See STRFUNCS
 
	PUBLISH XREF:	idxnstr

	PUBLISH NAME:	idxnstr
...
/*	***********************************************************************	*/
#ifndef NARGS
int idxnstr(const char *search_string, const char *target_string,
	size_t search_length)
#else
int idxnstr(search_string, target_string, search_length)
const char *search_string;
const char *target_string;
size_t      search_length;
#endif /* #ifndef NARGS */
{
	...
	if ((found_ptr = strnstr(search_string, target_string,
		search_length)) != NULL)
