...
/* BOH
   ...
   SYNOPSIS    :  return_code = strlni_find(string_count, string_list,
   ...
   RETURNS     :  Returns from this function are as follow:
						...
						(.) ''STRFUNCS_ITEM_NOT_FOUND'' if ``key_string`` is not found
						in the array ``string_list``. In this case, the unsigned int
						to which the ``found_index`` parameter points will be set to
						the index of the array into which ``key_string`` should be
						inserted.
   ...
   OUTPUT INDEX:  strlni_find
						String List Functions:strlni_find
						STRFUNCS:String List Functions:strlni_find
						String Functions:See STRFUNCS

   PUBLISH XREF:  strlni_find

   PUBLISH NAME:	strlni_find
...
/* *********************************************************************** */
#ifndef NARGS
int strlni_find(unsigned int string_count, char **string_list,
	const char *key_string, size_t string_length, unsigned int *found_index)
#else
int strlni_find(string_count, string_list, key_string, string_length,
	found_index)
unsigned int   string_count;
char         **string_list;
const char    *key_string;
...
#else
	return(STR_LIST_find(string_count, ((void **) string_list),
		key_string, string_length, found_index, STR_strnicmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
