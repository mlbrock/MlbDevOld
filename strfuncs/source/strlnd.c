...
/* BOH
   ...
   SYNOPSIS    :  return_code = strln_delta(string_count_1, string_list_1,
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						of pointers to strings using ``STR_strncmp``.
   ...
   OUTPUT INDEX:  strln_delta
						String List Delta Functions:strln_delta
						STRFUNCS:String List Delta Functions:strln_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  strln_delta

   PUBLISH NAME:	strln_delta
...
/* *********************************************************************** */
#ifndef NARGS
int strln_delta(unsigned int string_count_1, char **string_list_1,
	...
	size_t string_length)
#else
int strln_delta(string_count_1, string_list_1, string_count_2, string_list_2,
...
#endif /* #ifndef NARGS */
{
	...
	return(MEM_LIST_delta(NULL, string_count_1, ((void **) string_list_1),
		string_count_2, ((void **) string_list_2), uniq_count_1,
		uniq_list_1, uniq_count_2, uniq_list_2, diff_count, diff_list,
		same_count, same_list, string_length, STR_strncmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'strln_delta()'\n");
	fprintf(stderr, "---- -- -------- ---------------\n\n");
	...
	else if ((return_code = strln_delta(file_count_1, file_list_1, file_count_2,
