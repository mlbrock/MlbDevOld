...
/*
	...
	File Description	:	Array of pointers to strings non-search delta logic.
...
/* BOH
   ...
   DESCRIPTION :  Determines the delta between the elements in two arrays
						of pointers to strings using ``STR_strcmp``.
   ...
   OUTPUT INDEX:  strl_delta
						String List Delta Functions:strl_delta
						STRFUNCS:String List Delta Functions:strl_delta
						String Functions:See STRFUNCS

   PUBLISH XREF:  strl_delta

   PUBLISH NAME:	strl_delta
...
/* *********************************************************************** */
#ifndef NARGS
int strl_delta(unsigned int string_count_1, char **string_list_1,
...
#else
int strl_delta(string_count_1, string_list_1, string_count_2, string_list_2,
	uniq_count_1, uniq_list_1, uniq_count_2, uniq_list_2, diff_count,
	diff_list, same_count, same_list)
unsigned int   string_count_1;
char         **string_list_1;
unsigned int   string_count_2;
char         **string_list_2;
...
#endif /* #ifndef NARGS */
{
	...
	return(MEM_LIST_delta(NULL, string_count_1, ((void **) string_list_1),
		...
		same_count, same_list, 0,
		((int (*)(void *, const void *, const void *, size_t)) STR_strcmp)));
#else
	return(MEM_LIST_delta(NULL, string_count_1, ((void **) string_list_1),
		string_count_2, ((void **) string_list_2), uniq_count_1,
		uniq_list_1, uniq_count_2, uniq_list_2, diff_count, diff_list,
		same_count, same_list, 0, STR_strcmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "Test of function 'strl_delta()'\n");
	fprintf(stderr, "---- -- -------- --------------\n\n");
	...
	else if ((return_code = strl_delta(file_count_1, file_list_1, file_count_2,
