...
/* BOH
   ...
   SYNOPSIS    :  return_code = strli_find(string_count, string_list,
   ...
   OUTPUT INDEX:  strli_find
						String List Functions:strli_find
						STRFUNCS:String List Functions:strli_find
						String Functions:See STRFUNCS

   PUBLISH XREF:  strli_find

   PUBLISH NAME:	strli_find
...
/* *********************************************************************** */
#ifndef NARGS
int strli_find(unsigned int string_count, char **string_list,
	const char *key_string, unsigned int *found_index)
#else
int strli_find(string_count, string_list, key_string, found_index)
unsigned int   string_count;
char         **string_list;
const char    *key_string;
unsigned int  *found_index;
#endif /* #ifndef NARGS */
{
	...
	return(STR_LIST_find(string_count, ((void **) string_list),
		key_string, 0, found_index,
		((int (*)(void *, const void *, const void *, size_t)) STR_stricmp)));
#else
	return(STR_LIST_find(string_count, ((void **) string_list),
		key_string, 0, found_index, STR_stricmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
