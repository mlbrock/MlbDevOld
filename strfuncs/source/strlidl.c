...
/* BOH
   ...
   SYNOPSIS    :  return_code = strli_delete(string_count, string_list,
   ...
   OUTPUT INDEX:  strli_delete
						String List Functions:strli_delete
						STRFUNCS:String List Functions:strli_delete
						String Functions:See STRFUNCS

   PUBLISH XREF:  strli_delete

   PUBLISH NAME:	strli_delete
...
/* *********************************************************************** */
#ifndef NARGS
int strli_delete(unsigned int *string_count, char ***string_list,
	const char *key_string, unsigned int *found_index)
#else
int strli_delete(string_count, string_list, key_string, found_index)
unsigned int   *string_count;
char         ***string_list;
const char     *key_string;
unsigned int   *found_index;
...
#else
	return(STR_LIST_delete(*string_count, ((void **) *string_list),
		((void *) key_string), 0, found_index, STR_stricmp));
#endif /* #ifndef NARGS */
}
/* *********************************************************************** */
