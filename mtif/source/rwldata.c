...
/*
	...
	File Description	:	Manages reader/writer lock data access.
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_InitDataSInt(MTIF_RWL_DATA_SINT *data_ptr, MTIF_RWL_FLAG flags,
	const char *name, int new_value, char *error_text)
#else
int MTIF_RWL_InitDataSInt(data_ptr, flags, name, new_value, error_text)
...
#endif /* #ifndef NARGS */
{
	return(MTIF_RWL_InitDataBasic(&data_ptr->lock_data, flags, name,
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_DestroyDataSInt(MTIF_RWL_DATA_SINT *data_ptr, char *error_text)
#else
int MTIF_RWL_DestroyDataSInt(data_ptr, error_text)
MTIF_RWL_DATA_SINT *data_ptr;
char               *error_text;
#endif /* #ifndef NARGS */
{
	return(MTIF_RWL_DestroyDataBasic(&data_ptr->lock_data, error_text));
}
/*	***********************************************************************	*/

/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataSInt(MTIF_RWL_DATA_SINT *data_ptr)
#else
int MTIF_RWL_GetDataSInt(data_ptr)
MTIF_RWL_DATA_SINT *data_ptr;
#endif /* #ifndef NARGS */
{
	int old_value;

	MTIF_RWL_GetDataSIntBasic(data_ptr, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataSIntBasic(MTIF_RWL_DATA_SINT *data_ptr,
	int *old_value_ptr, char *error_text)
#else
int MTIF_RWL_GetDataSIntBasic(data_ptr, old_value_ptr, error_text)
MTIF_RWL_DATA_SINT *data_ptr;
int                *old_value_ptr;
char               *error_text;
#endif /* #ifndef NARGS */
{
	...
	if (((return_code = MTIF_RWL_GetDataBasic(&data_ptr->lock_data,
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataSInt(MTIF_RWL_DATA_SINT *data_ptr, int new_value)
#else
int MTIF_RWL_SetDataSInt(data_ptr, new_value)
MTIF_RWL_DATA_SINT *data_ptr;
int                 new_value;
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_SetDataSIntBasic(data_ptr, new_value, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataSIntBasic(MTIF_RWL_DATA_SINT *data_ptr, int new_value,
	int *old_value_ptr, char *error_text)
#else
int MTIF_RWL_SetDataSIntBasic(data_ptr, new_value, old_value_ptr, error_text)
MTIF_RWL_DATA_SINT *data_ptr;
int                 new_value;
int                *old_value_ptr;
char               *error_text;
#endif /* #ifndef NARGS */
{
	...
	if (((return_code = MTIF_RWL_SetDataBasic(&data_ptr->lock_data,
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_InitDataUInt(MTIF_RWL_DATA_UINT *data_ptr, MTIF_RWL_FLAG flags,
	const char *name, unsigned int new_value, char *error_text)
#else
int MTIF_RWL_InitDataUInt(data_ptr, flags, name, new_value, error_text)
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_DestroyDataUInt(MTIF_RWL_DATA_UINT *data_ptr, char *error_text)
#else
int MTIF_RWL_DestroyDataUInt(data_ptr, error_text)
MTIF_RWL_DATA_UINT *data_ptr;
char               *error_text;
#endif /* #ifndef NARGS */
{
...
/*	***********************************************************************	*/
#ifndef NARGS
unsigned int MTIF_RWL_GetDataUInt(MTIF_RWL_DATA_UINT *data_ptr)
#else
unsigned int MTIF_RWL_GetDataUInt(data_ptr)
MTIF_RWL_DATA_UINT *data_ptr;
#endif /* #ifndef NARGS */
{
	unsigned int old_value;

	MTIF_RWL_GetDataUIntBasic(data_ptr, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataUIntBasic(MTIF_RWL_DATA_UINT *data_ptr,
	unsigned int *old_value_ptr, char *error_text)
#else
int MTIF_RWL_GetDataUIntBasic(data_ptr, old_value_ptr, error_text)
MTIF_RWL_DATA_UINT *data_ptr;
...
/*	***********************************************************************	*/
#ifndef NARGS
unsigned int MTIF_RWL_SetDataUInt(MTIF_RWL_DATA_UINT *data_ptr,
	unsigned int new_value)
#else
unsigned int MTIF_RWL_SetDataUInt(data_ptr, new_value)
MTIF_RWL_DATA_UINT *data_ptr;
unsigned int        new_value;
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_SetDataUIntBasic(data_ptr, new_value, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataUIntBasic(MTIF_RWL_DATA_UINT *data_ptr,
	unsigned int new_value, unsigned int *old_value_ptr, char *error_text)
#else
int MTIF_RWL_SetDataUIntBasic(data_ptr, new_value, old_value_ptr, error_text)
MTIF_RWL_DATA_UINT *data_ptr;
unsigned int        new_value;
unsigned int       *old_value_ptr;
char               *error_text;
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_InitDataSLong(MTIF_RWL_DATA_SLONG *data_ptr, MTIF_RWL_FLAG flags,
	const char *name, long new_value, char *error_text)
#else
int MTIF_RWL_InitDataSLong(data_ptr, flags, name, new_value, error_text)
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_DestroyDataSLong(MTIF_RWL_DATA_SLONG *data_ptr, char *error_text)
#else
int MTIF_RWL_DestroyDataSLong(data_ptr, error_text)
MTIF_RWL_DATA_SLONG *data_ptr;
char                *error_text;
#endif /* #ifndef NARGS */
{
...
/*	***********************************************************************	*/
#ifndef NARGS
long MTIF_RWL_GetDataSLong(MTIF_RWL_DATA_SLONG *data_ptr)
#else
long MTIF_RWL_GetDataSLong(data_ptr)
MTIF_RWL_DATA_SLONG *data_ptr;
#endif /* #ifndef NARGS */
{
	long old_value;

	MTIF_RWL_GetDataSLongBasic(data_ptr, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataSLongBasic(MTIF_RWL_DATA_SLONG *data_ptr,
	long *old_value_ptr, char *error_text)
#else
int MTIF_RWL_GetDataSLongBasic(data_ptr, old_value_ptr, error_text)
MTIF_RWL_DATA_SLONG *data_ptr;
long                *old_value_ptr;
char                *error_text;
#endif /* #ifndef NARGS */
...
/*	***********************************************************************	*/
#ifndef NARGS
long MTIF_RWL_SetDataSLong(MTIF_RWL_DATA_SLONG *data_ptr, long new_value)
#else
long MTIF_RWL_SetDataSLong(data_ptr, new_value)
MTIF_RWL_DATA_SLONG *data_ptr;
long                 new_value;
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_SetDataSLongBasic(data_ptr, new_value, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataSLongBasic(MTIF_RWL_DATA_SLONG *data_ptr,
	long new_value, long *old_value_ptr, char *error_text)
#else
int MTIF_RWL_SetDataSLongBasic(data_ptr, new_value, old_value_ptr, error_text)
MTIF_RWL_DATA_SLONG *data_ptr;
long                 new_value;
long                *old_value_ptr;
char                *error_text;
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_InitDataULong(MTIF_RWL_DATA_ULONG *data_ptr, MTIF_RWL_FLAG flags,
	const char *name, unsigned long new_value, char *error_text)
#else
int MTIF_RWL_InitDataULong(data_ptr, flags, name, new_value, error_text)
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_DestroyDataULong(MTIF_RWL_DATA_ULONG *data_ptr, char *error_text)
#else
int MTIF_RWL_DestroyDataULong(data_ptr, error_text)
MTIF_RWL_DATA_ULONG *data_ptr;
char                *error_text;
#endif /* #ifndef NARGS */
{
...
/*	***********************************************************************	*/
#ifndef NARGS
unsigned long MTIF_RWL_GetDataULong(MTIF_RWL_DATA_ULONG *data_ptr)
#else
unsigned long MTIF_RWL_GetDataULong(data_ptr)
MTIF_RWL_DATA_ULONG *data_ptr;
#endif /* #ifndef NARGS */
{
	unsigned long old_value;

	MTIF_RWL_GetDataULongBasic(data_ptr, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataULongBasic(MTIF_RWL_DATA_ULONG *data_ptr,
	unsigned long *old_value_ptr, char *error_text)
#else
int MTIF_RWL_GetDataULongBasic(data_ptr, old_value_ptr, error_text)
MTIF_RWL_DATA_ULONG *data_ptr;
...
/*	***********************************************************************	*/
#ifndef NARGS
unsigned long MTIF_RWL_SetDataULong(MTIF_RWL_DATA_ULONG *data_ptr,
	unsigned long new_value)
#else
unsigned long MTIF_RWL_SetDataULong(data_ptr, new_value)
MTIF_RWL_DATA_ULONG *data_ptr;
unsigned long        new_value;
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_SetDataULongBasic(data_ptr, new_value, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataULongBasic(MTIF_RWL_DATA_ULONG *data_ptr,
	unsigned long new_value, unsigned long *old_value_ptr, char *error_text)
#else
int MTIF_RWL_SetDataULongBasic(data_ptr, new_value, old_value_ptr, error_text)
MTIF_RWL_DATA_ULONG *data_ptr;
unsigned long        new_value;
unsigned long       *old_value_ptr;
char                *error_text;
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_InitDataDouble(MTIF_RWL_DATA_DOUBLE *data_ptr, MTIF_RWL_FLAG flags,
	const char *name, double new_value, char *error_text)
#else
int MTIF_RWL_InitDataDouble(data_ptr, flags, name, new_value, error_text)
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_DestroyDataDouble(MTIF_RWL_DATA_DOUBLE *data_ptr, char *error_text)
#else
int MTIF_RWL_DestroyDataDouble(data_ptr, error_text)
MTIF_RWL_DATA_DOUBLE *data_ptr;
char                 *error_text;
#endif /* #ifndef NARGS */
{
...
/*	***********************************************************************	*/
#ifndef NARGS
double MTIF_RWL_GetDataDouble(MTIF_RWL_DATA_DOUBLE *data_ptr)
#else
double MTIF_RWL_GetDataDouble(data_ptr)
MTIF_RWL_DATA_DOUBLE *data_ptr;
#endif /* #ifndef NARGS */
{
	double old_value;

	MTIF_RWL_GetDataDoubleBasic(data_ptr, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataDoubleBasic(MTIF_RWL_DATA_DOUBLE *data_ptr,
	double *old_value_ptr, char *error_text)
#else
int MTIF_RWL_GetDataDoubleBasic(data_ptr, old_value_ptr, error_text)
MTIF_RWL_DATA_DOUBLE *data_ptr;
...
/*	***********************************************************************	*/
#ifndef NARGS
double MTIF_RWL_SetDataDouble(MTIF_RWL_DATA_DOUBLE *data_ptr, double new_value)
#else
double MTIF_RWL_SetDataDouble(data_ptr, new_value)
MTIF_RWL_DATA_DOUBLE *data_ptr;
double                new_value;
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_SetDataDoubleBasic(data_ptr, new_value, &old_value, NULL);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataDoubleBasic(MTIF_RWL_DATA_DOUBLE *data_ptr,
	double new_value, double *old_value_ptr, char *error_text)
#else
int MTIF_RWL_SetDataDoubleBasic(data_ptr, new_value, old_value_ptr, error_text)
MTIF_RWL_DATA_DOUBLE *data_ptr;
double                new_value;
double               *old_value_ptr;
char                 *error_text;
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_InitDataBasic(MTIF_RWL_HANDLE *lock_ptr, MTIF_RWL_FLAG flags,
	const char *name, void *value_ptr, unsigned int value_length,
	const void *new_data_ptr, char *error_text)
#else
int MTIF_RWL_InitDataBasic(lock_ptr, flags, name, value_ptr, value_length,
	new_data_ptr, error_text)
MTIF_RWL_HANDLE *lock_ptr;
MTIF_RWL_FLAG    flags;
const char      *name;
void            *value_ptr;
...
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = MTIF_RWL_Init(flags, name,  lock_ptr, error_text)) ==
		MTIF_SUCCESS)
		return_code = MTIF_RWL_SetDataBasic(lock_ptr, value_ptr, value_length,
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_DestroyDataBasic(MTIF_RWL_HANDLE *lock_ptr, char *error_text)
#else
int MTIF_RWL_DestroyDataBasic(lock_ptr, error_text)
MTIF_RWL_HANDLE *lock_ptr;
char            *error_text;
#endif /* #ifndef NARGS */
{
	return(MTIF_RWL_Destroy(lock_ptr, error_text));
}
/*	***********************************************************************	*/

/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_GetDataBasic(MTIF_RWL_HANDLE *lock_ptr, void *value_ptr,
	unsigned int value_length, void *old_value_ptr, char *error_text)
#else
int MTIF_RWL_GetDataBasic(lock_ptr, value_ptr, value_length, old_value_ptr,
	error_text)
MTIF_RWL_HANDLE *lock_ptr;
void            *value_ptr;
unsigned int     value_length;
...
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = MTIF_RWL_LockReader(lock_ptr, error_text)) ==
		MTIF_SUCCESS) {
		if (old_value_ptr != NULL)
			memcpy(old_value_ptr, value_ptr, value_length);
		MTIF_RWL_Unlock(lock_ptr, NULL);
	}
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SetDataBasic(MTIF_RWL_HANDLE *lock_ptr, void *value_ptr,
	unsigned int value_length, const void *new_value_ptr, void *old_value_ptr,
	char *error_text)
#else
int MTIF_RWL_SetDataBasic(lock_ptr, value_ptr, value_length, new_value_ptr,
...
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = MTIF_RWL_LockWriter(lock_ptr, error_text)) ==
		MTIF_SUCCESS) {
		if (value_length) {
			if (old_value_ptr != NULL)
				memcpy(old_value_ptr, value_ptr, value_length);
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SpinOnDataSIntUSecs(MTIF_RWL_DATA_SINT *data_ptr, int test_value,
	unsigned int spin_count, unsigned long spin_usecs)
#else
int MTIF_RWL_SpinOnDataSIntUSecs(data_ptr, test_value, spin_count, spin_usecs)
MTIF_RWL_DATA_SINT *data_ptr;
int                 test_value;
...
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_SpinOnDataUSecsBasic(&data_ptr->lock_data, &data_ptr->value,
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SpinOnNotDataSIntUSecs(MTIF_RWL_DATA_SINT *data_ptr,
	int test_value, unsigned int spin_count, unsigned long spin_usecs)
#else
int MTIF_RWL_SpinOnNotDataSIntUSecs(data_ptr, test_value, spin_count,
	spin_usecs)
MTIF_RWL_DATA_SINT *data_ptr;
int                 test_value;
unsigned int        spin_count;
...
/*	***********************************************************************	*/
#ifndef NARGS
int MTIF_RWL_SpinOnDataUSecsBasic(MTIF_RWL_HANDLE *lock_ptr,
...
#else
int MTIF_RWL_SpinOnDataUSecsBasic(lock_ptr, value_ptr, value_length,
...
#endif /* #ifndef NARGS */
{
	...
	do {
		if ((return_code = MTIF_RWL_TryLockReader(lock_ptr, error_text)) ==
			MTIF_SUCCESS) {
			memcpy(old_value_ptr, value_ptr, value_length);
			MTIF_RWL_Unlock(lock_ptr, NULL);
...
COMPAT_FN_DECL_STATIC(int   TEST_DoIterations,
	...
	unsigned long sleep_modulus, MTIF_RWL_DATA_SINT *data_ptr,
	char *error_text));
...
#endif /* #ifndef NARGS */
{
	...
	MTIF_RWL_DATA_SINT  data_static     = MTIF_RWL_DATA_SINT_STATIC_INIT(54321);
	MTIF_RWL_DATA_SINT  data_dynamic;
	unsigned int        count_1;
	char                error_text[MTIF_MAX_ERROR_TEXT];

	fprintf(stderr, "Test harness routine for 'MTIF_RWL_InitSInt()'\n");
	fprintf(stderr, "                         'MTIF_RWL_GetSIntBasic()'\n");
	fprintf(stderr, "                         'MTIF_RWL_SetSIntBasic()'\n");
	fprintf(stderr, "                         'MTIF_RWL_DestroySInt()'\n");
	fprintf(stderr, "                         'MTIF_RWL_InitBasic()'\n");
	fprintf(stderr, "                         'MTIF_RWL_GetBasic()'\n");
	fprintf(stderr, "                         'MTIF_RWL_SetBasic()'\n");
	fprintf(stderr, "                         'MTIF_RWL_DestroyBasic()'\n");
	fprintf(stderr, "---- ------- ------- --- -------------------------\n\n");
	...
	if ((return_code = MTIF_RWL_InitDataSInt(&data_dynamic,
		MTIF_RWL_FLAG_DEFAULT, NULL, 12345, error_text)) != MTIF_SUCCESS)
		goto EXIT_FUNCTION;
	...
	if ((return_code = TEST_DoIterations(iteration_count, thread_count,
		...
		MTIF_RWL_DestroyDataSInt(&data_dynamic, NULL);
		goto EXIT_FUNCTION;
	}
	return_code = MTIF_RWL_DestroyDataSInt(&data_dynamic, error_text);
	/*	*****************************************************************	*/
...
#endif /* #ifndef NARGS */
{
	...
	if (start_data->get_flag &&
		((return_code = MTIF_RWL_GetDataSIntBasic(start_data->data_ptr,
		...
		((return_code = MTIF_RWL_SetDataSIntBasic(start_data->data_ptr,
...
#endif /* #ifndef NARGS */
{
	...
	fprintf(stderr, "********** rwl_data    = %11lu\n",
		((unsigned long) start_data->data_ptr->lock_data.rwl_data));
	fprintf(stderr, "********** rwl_name    =  %s\n",
		(start_data->data_ptr->lock_data.rwl_name == NULL) ? "*** NONE ***" :
		start_data->data_ptr->lock_data.rwl_name);
#else
	fprintf(stderr, "********** rwl_data    = %11lu\n",
		((unsigned long) &start_data->data_ptr->lock_data.rwl_data));
