...
/*
	...
	File Description	:	Include file for set_LC<>.
...
#ifndef HH__MLB__CPPSupp__STLSupp__set_LC_h__HH

#define HH__MLB__CPPSupp__STLSupp__set_LC_h__HH	1
...
template <class DataType, class LockType = MLB::CPPSupp::NullLock,
	...
	private:
		...
		//	////////////////////////////////////////////////////////////////
		typedef std::set<DataType, PredType, AllocType>         BaseCollType;
		typedef set_LC<DataType, LockType, PredType, AllocType> ThisCollType;
		//	////////////////////////////////////////////////////////////////
...
//	std::vector::pointer not supported in Dinkumware for MSc++ version 6
		...
		typedef typename AllocType::const_pointer               const_pointer;
#else
	...
	public:
		/*	***********************************************************
			...
			***********************************************************	*/
		explicit set_LC(const ValueCompare &pred = PredType(),
		...
		//	////////////////////////////////////////////////////////////////
#if defined(_MSC_VER) && (_MSC_VER < 1300) && defined(_SET_)
		set_LC(ConstIter first_iter, ConstIter last_iter,
...
/*
		set_LC(const ValueType *first_iter, const ValueType *last_iter,
			const ValueCompare &pred = PredType(),
			const AllocType &alloc = AllocType()) :
			coll_lock(), coll_data(first_iter, last_iter, pred, alloc) { }
*/
#else
		template <class InputIterator> set_LC(InputIterator first_iter,
		...
		//	////////////////////////////////////////////////////////////////
		set_LC(const BaseCollType &in_coll) :
		...
		/*	***********************************************************
			...
			***********************************************************	*/
		set_LC(const ThisCollType &in_coll) :
			coll_lock(), coll_data() {
		...
		std::pair<Iter, bool> Insert(const ValueType &in_value) {
			MyLockWriter my_lock(*this);
...
template <class DataType, class LockType, class PredType, class AllocType>
	inline void swap(set_LC<DataType, LockType, PredType, AllocType> &lhs,
	set_LC<DataType, LockType, PredType, AllocType> &rhs)
{
	lhs.Swap(rhs);
}
//	////////////////////////////////////////////////////////////////////////////
...
#endif // #ifndef HH__MLB__CPPSupp__STLSupp__set_LC_h__HH
