...
/*
	...
	File Description	:	Include file for deque_LC<>.
...
#ifndef HH__MLB__CPPSupp__STLSupp__deque_LC_h__HH

#define HH__MLB__CPPSupp__STLSupp__deque_LC_h__HH	1
...
template <class DataType, class LockType = MLB::CPPSupp::NullLock,
	...
	private:
		...
		//	////////////////////////////////////////////////////////////////
		typedef std::deque<DataType, AllocType>                 BaseCollType;
		typedef deque_LC<DataType, LockType, AllocType>         ThisCollType;
		//	////////////////////////////////////////////////////////////////
	...
	public:
		...
		//		deque_LC<SomeType> some_instance;
		//
...
//	std::deque::pointer not supported in Dinkumware for MSc++ version 6
#if defined(_MSC_VER) && (_MSC_VER < 1300) && defined(_DEQUE_)
...
#endif // #if defined(_MSC_VER) && (_MSC_VER < 1300) && defined(_DEQUE_)
	...
	public:
		...
		/*	***********************************************************
			...
			***********************************************************	*/
		explicit deque_LC(const AllocType& alloc = AllocType()) :
			coll_lock(), coll_data(alloc) { }
		explicit deque_LC(SizeType in_count, const DataType &data = DataType(),
		...
		//	////////////////////////////////////////////////////////////////
#if defined(_MSC_VER) && (_MSC_VER < 1300) && defined(_DEQUE_)
		deque_LC(ConstIter first_iter, ConstIter last_iter,
			const AllocType &alloc = AllocType()) :
			coll_lock(), coll_data(first_iter, last_iter, alloc) { }
#else
		template <class InputIterator> deque_LC(InputIterator first_iter,
		...
		//	////////////////////////////////////////////////////////////////
		deque_LC(const BaseCollType &in_coll) :
		...
		/*	***********************************************************
			...
			***********************************************************	*/
		deque_LC(const ThisCollType &in_coll) :
			coll_lock(), coll_data() {
...
//	using protected inheritance from _Deque_base<>. Hence this work-around.
			...
			return(reinterpret_cast<const std::_Deque_base<DataType, AllocType> *>
				(&coll_data)->get_allocator());
#else
	...
	private:
		...
		std::deque<DataType, AllocType> coll_data;
		/*	***********************************************************	*/
};
/*	***********************************************************************	*/
...
template <class DataType, class LockType, class AllocType>
	inline void swap(deque_LC<DataType, LockType, AllocType> &lhs,
	deque_LC<DataType, LockType, AllocType>  &rhs) {
	lhs.Swap(rhs);
}
//	////////////////////////////////////////////////////////////////////////////
...
#endif // #ifndef HH__MLB__CPPSupp__STLSupp__deque_LC_h__HH
