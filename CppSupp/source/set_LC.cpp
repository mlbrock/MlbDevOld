...
/*
	...
	File Description	:	Test harness module for template class set_LC<>.
...
/*	***********************************************************************	*/
typedef std::set<int>                                       BaseCollType;
typedef MLB::CPPSupp::STLSupp::set_LC<int>                  NullCollType;
typedef MLB::CPPSupp::STLSupp::set_LC<int, MLB::MTIF::MtrO> ThisCollType;
...
int main(int argc, char **argv)
{
	...
	std::cerr << "Test harness for MLB::CPPSupp::STLSupp::set_LC<>" <<
		std::endl << std::endl;
	...
	TEST_SUPP_EmitBarEqual();
	std::cout << "Test harness for MLB::CPPSupp::STLSupp::set_LC<>" <<
		std::endl;
	TEST_SUPP_EmitBarEqual();
...
static bool TEST_ScopedLocks(const char *func_name, unsigned int element_count)
{
	...
	try {
		...
		TEST_SUPP_EmitResults(func_name,
			((reader_test) ? "set_LC::MyLockReader()" : "set_LC::MyLockWriter()"),
...
static bool TEST_Cons_1_A(const char *func_name, unsigned int element_count)
{
	...
	if ((ok_flag = TEST_SUPP_EmitResults(func_name, "set_LC::set_LC()",
		ok_flag,
		(this_coll == base_coll),
		...
		ok_flag = TEST_SUPP_EmitResults(func_name,
			"set_LC::set_LC() --- with data", ok_flag,
			(this_coll == base_coll),
	...
	unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::set_LC(set<>::begin(), set<>::end())", ok_flag,
		(this_coll == base_coll),
		"(this_coll == base_coll)");
	...
	unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::set_LC(const set<> &)", ok_flag,
		(this_coll == base_coll),
		"(this_coll == base_coll)");
...
static bool TEST_ConsCopy(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::set_LC(const set_LC<> &)", ok_flag,
		(this_coll == copy_coll),
		"(this_coll == copy_coll)");
...
static bool TEST_Empty(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Empty() --- before set_LC::Clear()",
		ok_flag,
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Empty() --- after set_LC::Clear()",
		ok_flag,
...
static bool TEST_Erase_1(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Erase(Iter *middle-of-container*)",
		ok_flag,
		(this_coll == base_coll),
		"(this_coll == base_coll)");
...
static bool TEST_Erase_2(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Erase(set_LC::Begin(), set_LC::End())",
		ok_flag,
		(this_coll == base_coll),
		"(this_coll == base_coll)");
...
static bool TEST_Insert_1(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Insert(Iter position = set_LC::Begin(), -1)",
		ok_flag,
		(this_coll == base_coll),
		"(set_LC<> == set<>)");
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Insert(Iter position = set_LC::End(), -2)",
		ok_flag,
		(this_coll == base_coll),
		"(set_LC<> == set<>)");
...
static bool TEST_Insert_2(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Insert(Iter position = set_LC::Begin(), element_count, -1)",
		ok_flag,
		(this_coll == base_coll),
		"(set_LC<> == set<>)");
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Insert(Iter position = set_LC::End(), element_count, -2)",
		ok_flag,
		(this_coll == base_coll),
		"(set_LC<> == set<>)");
...
//	MSC version 6.0 doesn't support this set::insert() correctly.
#ifdef _MSC_VER
# if _MSC_VER >= 1300
...
# endif // # if _MSC_VER >= 1300
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Insert(Iter position = set_LC::Begin(), \
set<>::begin(), set<>::end())",
		ok_flag,
		(this_coll == base_coll),
		"(set_LC<> == set<>)");
...
# endif // # if _MSC_VER >= 1300
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC::Insert(Iter position = set_LC::End(), \
set<>::begin(), set<>::end())",
		ok_flag,
		(this_coll == base_coll),
		"(set_LC<> == set<>)");
...
static bool TEST_Op_Eq(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC<element_count, 12345> == set_LC<element_count, 12345>",
		ok_flag,
		(this_coll_1 == this_coll_2),
		"(set_LC<> == set_LC<>)");

	ok_flag = TEST_SUPP_EmitResults(func_name,
		"!(set_LC<element_count, 12345> == set_LC<element_count, 54321>)",
		ok_flag,
		!(this_coll_1 == this_coll_3),
		"!(set_LC<> == set_LC<>)");

	ok_flag = TEST_SUPP_EmitResults(func_name,
		"!(set_LC<element_count, 12345> == set_LC<element_count + 1, 12345>)",
		ok_flag,
		!(this_coll_1 == this_coll_4),
		"!(set_LC<> == set_LC<>)");

	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC<element_count, 12345> == set<element_count, 12345>",
		ok_flag,
		(this_coll_1 == base_coll),
		"(set_LC<> == set<>)");

	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set<element_count, 12345> == set_LC<element_count, 12345>",
		ok_flag,
...
static bool TEST_GetData_2(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"void set_LC::GetData(set_LC<> &)", ok_flag,
...
static bool TEST_GetDataRef(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC<> &set_LC::GetDataRef()", ok_flag,
		(this_coll.GetDataRef() == base_coll),
		"this_coll.GetDataRef() == base_coll");
...
static bool TEST_GetDataPtr(const char *func_name, unsigned int element_count)
{
	...
	ok_flag = TEST_SUPP_EmitResults(func_name,
		"set_LC<> *set_LC::GetDataPtr()", ok_flag,
