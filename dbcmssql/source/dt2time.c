...
/*	***********************************************************************	*/
int DBC_MSSQL_DTIMEToTime(dbc_type, dtime_ptr, time_ptr, error_text)
int          dbc_type;
...
char        *error_text;
{
	...
	switch (dbc_type) {
		case SQLDATETIM4	:
			DBC_MSSQL_DTIMEToMSSQL4(dtime_ptr, ((DBDATETIM4 *) time_ptr));
			break;
		case SQLDATETIME	:
			DBC_MSSQL_DTIMEToMSSQL8(dtime_ptr, ((DBDATETIME *) time_ptr));
			break;
		default				:
