...
/*
	...
	File Description	:	Generic comparison of Microsoft SQL Server date types.
...
/*	***********************************************************************	*/
int DBC_MSSQL_CMP_Date(dbc_type, ptr_1, ptr_2)
int         dbc_type;
const void *ptr_1;
const void *ptr_2;
{
...
/*	***********************************************************************	*/
int DBC_MSSQL_SCMP_Date(control_ptr, ptr_1, ptr_2, data_length)
void       *control_ptr;
const void *ptr_1;
const void *ptr_2;
size_t      data_length;
{
	return(DBC_MSSQL_CMP_Date(((int) data_length), ptr_1, ptr_2));
}
/*	***********************************************************************	*/
