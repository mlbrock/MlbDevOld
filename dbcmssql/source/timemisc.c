...
/*
	...
	File Description	:	Miscellaneous Microsoft SQL Server time type functions.
...
/*	***********************************************************************	*/
int DBC_MSSQL_MinTime(dbc_type, dtime_ptr, error_text)
int    dbc_type;
DTIME *dtime_ptr;
char  *error_text;
{
...
/*	***********************************************************************	*/
int DBC_MSSQL_MaxTime(dbc_type, dtime_ptr, error_text)
int    dbc_type;
DTIME *dtime_ptr;
char  *error_text;
{
