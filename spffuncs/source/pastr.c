...
/*
	...
	File Description	:	Parses strings.
...
/*	***********************************************************************	*/
#ifndef NARGS
int SPF_PARSE_StringList(const SPF_SPEC *spec_ptr, const SPF_PARSE *parse_ptr,
	unsigned int *string_count, char ***string_list, char *error_text)
#else
int SPF_PARSE_StringList(spec_ptr, parse_ptr, string_count, string_list,
	error_text)
...
#endif /* #ifndef NARGS */
{
	...
	if ((return_code = SPF_PARSE_String(spec_ptr, parse_ptr, &string_ptr,
...
/*	***********************************************************************	*/
#ifndef NARGS
int SPF_PARSE_String(const SPF_SPEC *spec_ptr, const SPF_PARSE *parse_ptr,
	char **string_ptr, char *error_text)
#else
int SPF_PARSE_String(spec_ptr, parse_ptr, string_ptr, error_text)
const SPF_SPEC   *spec_ptr;
const SPF_PARSE  *parse_ptr;
char            **string_ptr;
char             *error_text;
