...
/*
	...
	File Description	:	Removes the specified node in a doubly-linked list.
...
/*	***********************************************************************	*/
void DLLS_RemoveSelf(DLLS_NODE *node_ptr)
{
	if (node_ptr->prev_ptr == NULL)
		DLLS_RemoveFirst(node_ptr->dlls_ptr);
	else
		DLLS_RemoveNext(node_ptr->prev_ptr);
}
/*	***********************************************************************	*/
...
int main(int argc, char **argv)
{
	...
	fprintf(stderr, "Test harness for function 'DLLS_RemoveSelf()'\n");
	fprintf(stderr, "---- ------- --- -------- -------------------\n\n");
